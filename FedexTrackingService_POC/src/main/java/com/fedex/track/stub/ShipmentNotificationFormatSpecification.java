...
public class ShipmentNotificationFormatSpecification  implements java.io.Serializable {
    private com.fedex.track.stub.NotificationFormatType type;

    public ShipmentNotificationFormatSpecification() {
    }

    public ShipmentNotificationFormatSpecification(
           com.fedex.track.stub.NotificationFormatType type) {
           this.type = type;
    }
     ...
     * @return type
     */
    public com.fedex.track.stub.NotificationFormatType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.track.stub.NotificationFormatType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "ShipmentNotificationFormatSpecification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("type");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "Type"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "NotificationFormatType"));
