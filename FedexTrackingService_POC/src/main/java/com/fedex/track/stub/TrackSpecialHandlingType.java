...
public class TrackSpecialHandlingType implements java.io.Serializable {
    ...
    // Constructor
    protected TrackSpecialHandlingType(java.lang.String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final java.lang.String _ACCESSIBLE_DANGEROUS_GOODS = "ACCESSIBLE_DANGEROUS_GOODS";
    public static final java.lang.String _ADULT_SIGNATURE_OPTION = "ADULT_SIGNATURE_OPTION";
    public static final java.lang.String _AIRBILL_AUTOMATION = "AIRBILL_AUTOMATION";
    public static final java.lang.String _AIRBILL_DELIVERY = "AIRBILL_DELIVERY";
    public static final java.lang.String _ALCOHOL = "ALCOHOL";
    public static final java.lang.String _AM_DELIVERY_GUARANTEE = "AM_DELIVERY_GUARANTEE";
    public static final java.lang.String _APPOINTMENT_DELIVERY = "APPOINTMENT_DELIVERY";
    public static final java.lang.String _BILL_RECIPIENT = "BILL_RECIPIENT";
    ...
    public static final java.lang.String _CALL_TAG = "CALL_TAG";
    public static final java.lang.String _CALL_TAG_DAMAGE = "CALL_TAG_DAMAGE";
    public static final java.lang.String _CHARGEABLE_CODE = "CHARGEABLE_CODE";
    public static final java.lang.String _COD = "COD";
    public static final java.lang.String _COLLECT = "COLLECT";
    public static final java.lang.String _CONSOLIDATION = "CONSOLIDATION";
    public static final java.lang.String _CONSOLIDATION_SMALLS_BAG = "CONSOLIDATION_SMALLS_BAG";
    public static final java.lang.String _CURRENCY = "CURRENCY";
    public static final java.lang.String _CUT_FLOWERS = "CUT_FLOWERS";
    public static final java.lang.String _DATE_CERTAIN_DELIVERY = "DATE_CERTAIN_DELIVERY";
    public static final java.lang.String _DELIVERY_ON_INVOICE_ACCEPTANCE = "DELIVERY_ON_INVOICE_ACCEPTANCE";
    public static final java.lang.String _DELIVERY_REATTEMPT = "DELIVERY_REATTEMPT";
    public static final java.lang.String _DELIVERY_RECEIPT = "DELIVERY_RECEIPT";
    public static final java.lang.String _DELIVER_WEEKDAY = "DELIVER_WEEKDAY";
    public static final java.lang.String _DIRECT_SIGNATURE_OPTION = "DIRECT_SIGNATURE_OPTION";
    ...
    public static final java.lang.String _DRY_ICE_ADDED = "DRY_ICE_ADDED";
    public static final java.lang.String _EAST_COAST_SPECIAL = "EAST_COAST_SPECIAL";
    public static final java.lang.String _ELECTRONIC_COD = "ELECTRONIC_COD";
    public static final java.lang.String _ELECTRONIC_SIGNATURE_SERVICE = "ELECTRONIC_SIGNATURE_SERVICE";
    public static final java.lang.String _EVENING_DELIVERY = "EVENING_DELIVERY";
    public static final java.lang.String _EXCLUSIVE_USE = "EXCLUSIVE_USE";
    public static final java.lang.String _EXTENDED_DELIVERY = "EXTENDED_DELIVERY";
    public static final java.lang.String _EXTENDED_PICKUP = "EXTENDED_PICKUP";
    public static final java.lang.String _EXTRA_LABOR = "EXTRA_LABOR";
    public static final java.lang.String _EXTREME_LENGTH = "EXTREME_LENGTH";
    public static final java.lang.String _FOOD = "FOOD";
    public static final java.lang.String _FREIGHT_ON_VALUE_CARRIER_RISK = "FREIGHT_ON_VALUE_CARRIER_RISK";
    public static final java.lang.String _FREIGHT_ON_VALUE_OWN_RISK = "FREIGHT_ON_VALUE_OWN_RISK";
    public static final java.lang.String _FREIGHT_TO_COLLECT = "FREIGHT_TO_COLLECT";
    public static final java.lang.String _FULLY_REGULATED_DANGEROUS_GOODS = "FULLY_REGULATED_DANGEROUS_GOODS";
    public static final java.lang.String _GEL_PACKS_ADDED_OR_REPLACED = "GEL_PACKS_ADDED_OR_REPLACED";
    public static final java.lang.String _GROUND_SUPPORT_FOR_SMARTPOST = "GROUND_SUPPORT_FOR_SMARTPOST";
    public static final java.lang.String _GUARANTEED_FUNDS = "GUARANTEED_FUNDS";
    public static final java.lang.String _HAZMAT = "HAZMAT";
    public static final java.lang.String _HIGH_FLOOR = "HIGH_FLOOR";
    public static final java.lang.String _HOLD_AT_LOCATION = "HOLD_AT_LOCATION";
    public static final java.lang.String _HOLIDAY_DELIVERY = "HOLIDAY_DELIVERY";
    public static final java.lang.String _INACCESSIBLE_DANGEROUS_GOODS = "INACCESSIBLE_DANGEROUS_GOODS";
    public static final java.lang.String _INDIRECT_SIGNATURE_OPTION = "INDIRECT_SIGNATURE_OPTION";
    ...
    public static final java.lang.String _INTERNATIONAL_CONTROLLED_EXPORT = "INTERNATIONAL_CONTROLLED_EXPORT";
    public static final java.lang.String _INTERNATIONAL_MAIL_SERVICE = "INTERNATIONAL_MAIL_SERVICE";
    ...
    public static final java.lang.String _LIFTGATE = "LIFTGATE";
    ...
    public static final java.lang.String _LIMITED_QUANTITIES_DANGEROUS_GOODS = "LIMITED_QUANTITIES_DANGEROUS_GOODS";
    public static final java.lang.String _MARKING_OR_TAGGING = "MARKING_OR_TAGGING";
    public static final java.lang.String _NET_RETURN = "NET_RETURN";
    public static final java.lang.String _NON_BUSINESS_TIME = "NON_BUSINESS_TIME";
    public static final java.lang.String _NON_STANDARD_CONTAINER = "NON_STANDARD_CONTAINER";
    public static final java.lang.String _NO_SIGNATURE_REQUIRED_SIGNATURE_OPTION = "NO_SIGNATURE_REQUIRED_SIGNATURE_OPTION";
    public static final java.lang.String _ORDER_NOTIFY = "ORDER_NOTIFY";
    public static final java.lang.String _OTHER = "OTHER";
    public static final java.lang.String _OTHER_REGULATED_MATERIAL_DOMESTIC = "OTHER_REGULATED_MATERIAL_DOMESTIC";
    public static final java.lang.String _PACKAGE_RETURN_PROGRAM = "PACKAGE_RETURN_PROGRAM";
    ...
    public static final java.lang.String _RAIL_MODE = "RAIL_MODE";
    public static final java.lang.String _RECONSIGNMENT_CHARGES = "RECONSIGNMENT_CHARGES";
    public static final java.lang.String _REROUTE_CROSS_COUNTRY_DEFERRED = "REROUTE_CROSS_COUNTRY_DEFERRED";
    public static final java.lang.String _REROUTE_CROSS_COUNTRY_EXPEDITED = "REROUTE_CROSS_COUNTRY_EXPEDITED";
    public static final java.lang.String _REROUTE_LOCAL = "REROUTE_LOCAL";
    ...
    public static final java.lang.String _RETURNS_CLEARANCE_SPECIAL_ROUTING_REQUIRED = "RETURNS_CLEARANCE_SPECIAL_ROUTING_REQUIRED";
    public static final java.lang.String _RETURN_MANAGER = "RETURN_MANAGER";
    public static final java.lang.String _SATURDAY_DELIVERY = "SATURDAY_DELIVERY";
    public static final java.lang.String _SHIPMENT_PLACED_IN_COLD_STORAGE = "SHIPMENT_PLACED_IN_COLD_STORAGE";
    public static final java.lang.String _SINGLE_SHIPMENT = "SINGLE_SHIPMENT";
    public static final java.lang.String _SMALL_QUANTITY_EXCEPTION = "SMALL_QUANTITY_EXCEPTION";
    public static final java.lang.String _SORT_AND_SEGREGATE = "SORT_AND_SEGREGATE";
    public static final java.lang.String _SPECIAL_DELIVERY = "SPECIAL_DELIVERY";
    public static final java.lang.String _SPECIAL_EQUIPMENT = "SPECIAL_EQUIPMENT";
    public static final java.lang.String _STANDARD_GROUND_SERVICE = "STANDARD_GROUND_SERVICE";
    public static final java.lang.String _STORAGE = "STORAGE";
    public static final java.lang.String _SUNDAY_DELIVERY = "SUNDAY_DELIVERY";
    public static final java.lang.String _THIRD_PARTY_BILLING = "THIRD_PARTY_BILLING";
    ...
    public static final java.lang.String _WEEKEND_DELIVERY = "WEEKEND_DELIVERY";
    public static final java.lang.String _WEEKEND_PICKUP = "WEEKEND_PICKUP";
    ...
    public static TrackSpecialHandlingType fromValue(java.lang.String value)
    ...
    public static TrackSpecialHandlingType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "TrackSpecialHandlingType"));
    }
    /**
