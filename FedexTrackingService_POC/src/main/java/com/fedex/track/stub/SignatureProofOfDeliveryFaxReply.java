...
public class SignatureProofOfDeliveryFaxReply  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryFaxReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "FaxConfirmationNumber"));
