...
public class PhysicalPackagingType implements java.io.Serializable {
    ...
    public static final java.lang.String _SACK = "SACK";
    public static final java.lang.String _SHRINK_WRAPPED = "SHRINK_WRAPPED";
    public static final java.lang.String _SKID = "SKID";
    public static final java.lang.String _TANK = "TANK";
    public static final java.lang.String _TOTE_BIN = "TOTE_BIN";
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "PhysicalPackagingType"));
    }
    /**
