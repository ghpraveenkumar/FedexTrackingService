...
public class TrackChargesPaymentClassificationType implements java.io.Serializable {
    ...
    // Constructor
    protected TrackChargesPaymentClassificationType(java.lang.String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final java.lang.String _DUTIES_AND_TAXES = "DUTIES_AND_TAXES";
    ...
    public static TrackChargesPaymentClassificationType fromValue(java.lang.String value)
    ...
    public static TrackChargesPaymentClassificationType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "TrackChargesPaymentClassificationType"));
    }
    /**
