...
public class Distance  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "Distance"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "DistanceUnits"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
