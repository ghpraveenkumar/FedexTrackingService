...
public class SignatureProofOfDeliveryLetterReply  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "SignatureProofOfDeliveryLetterReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v12", "Letter"));
